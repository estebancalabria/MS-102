# [TEÓRICO] Exploración Microsoft Defender XDR (**Slides:** 41-51)
---
...
* [BROWSER] https://security.microsoft.com
    * [MENU] Email & collaboration → Explorer
        * 👁️ -> Correos detectados como phishing
        * 👁️ -> Safe Links
        * 👁️ -> Safe Attachments
        * 👁️ -> Acciones realizadas sobre mensajes
...
* [BROWSER] https://security.microsoft.com
    * [MENU] Assets → Identities
        * 👁️ -> Identidades monitorizadas
        * 👁️ -> Alertas relacionadas con identidades
...
* [BROWSER] https://security.microsoft.com
    * [MENU] Email & collaboration → Explorer
        ...
        * 👁️ -> Actividad detectada en el tenant
