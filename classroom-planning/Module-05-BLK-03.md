# [TEÓRICO] Protección del correo con Microsoft Defender for Office 365
**Slides:** 14-23
...
* [BROWSER] https://security.microsoft.com
    ...
    * [MENU] Email & collaboration → Policies & rules → Threat policies
        ...
        * 👁️ -> Configuraciones disponibles de Defender for Office 365

        * 👁️ -> Opciones de protección avanzada
...
* [BROWSER] https://security.microsoft.com
    ...
    * [MENU] Email & collaboration → Policies & rules → Threat policies
        ...
        * [MENU] Tenant Allow/Block Lists

            * 👁️ -> Spoofed senders

            * 👁️ -> Entradas permitidas y bloqueadas
...
* [BROWSER] https://security.microsoft.com
    ...
    * [MENU] Email & collaboration → Submissions

        * 👁️ -> Submitted emails

        * 👁️ -> Submitted URLs

        * 👁️ -> Resultados de análisis

---

# Resumen del bloque

1. Comprender el valor agregado de Microsoft Defender for Office 365.
2. Analizar Safe Attachments y Safe Links.
3. Revisar las capacidades de Spoof Intelligence.
4. Administrar políticas de correo saliente.
5. Utilizar Submissions para investigar amenazas.
